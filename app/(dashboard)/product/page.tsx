        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
            ...
            <nav className="text-sm text-gray-500 mb-6">
                <ol className="flex space-x-2">
                    ...
                    <li>/</li>
                    <li><a href="/shop" className="hover:text-green-600">{t.common.products}</a></li>
                    <li>/</li>
                    ...
                    <div className="flex space-x-4 overflow-x-auto pb-2">
                        {product.images.map((img, idx) => (
                            <button
                                ...
                                className={`flex-shrink-0 h-20 w-20 rounded-md overflow-hidden border-2 ${selectedImage === idx ? 'border-green-600' : 'border-transparent'}`}
                            >
                                <img
                                    src={img.url}
                    ...
                    <div>
                        ...
                        <div className="flex items-center mt-2 space-x-2">
                            ...
                            <span className="text-sm text-gray-600">
                                {product.rate}/5 ({reviews.length} {t.product.rating})
                            </span>
                        </div>
                    </div>
