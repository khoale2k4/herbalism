...
const BusinessForGood = ({ icons }: Props) => {
    ...
    return (
        // <div
        //     ref={ref}
        //     className={`relative overflow-hidden transition-opacity duration-700 min-h-[400px] bg-[#fdf8f7] ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        //         }`}
        // >
            <section className="bg-[#fdf8f7] py-16 w-full"> 
