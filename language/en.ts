export default {
    ...
    navbar: {
        ...
        marquee: {
            message1: "Welcome!",
            message2: "Enjoy a wonderful day!",
            message3: "Discover our amazing products!",
    ...
    collections: {
        title: "Plant Medicine with Purpose",
        description:
            "Harmonic Arts provides effective and easy-to-use herbal products that empower people on their path to wellness.",
    ...
    features: {
        spinningWords: "Harmonic Arts - Nature & Wellness",
        heading: "Harmonic Arts - Nature & Wellness",
        subheading: "The Harmonic Arts Difference",
        description:
        ...
        ingredients: {
            icon: "🌱",
            title: "Ingredients Sourced from Nature",
            description:
